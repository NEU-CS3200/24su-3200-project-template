...
@students.route('/students/majors', methods = ['POST','GET'])
# this a route to get all of the majors 
def get_all_majors():
    current_app.logger.info('student_routes.py: GET /students/majors')
    cursor = db.get_db().cursor()
    the_query = '''SELECT DISTINCT major FROM Student;;
    '''
